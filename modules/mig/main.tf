...
resource "google_compute_health_check" "mig-healthcheck" {
  count   = var.health_check["type"] == "mig-healthcheck" ? 1 : 0
  project = var.project_id
  name    = "${var.hostname}-mig-healthcheck"
...
resource "google_compute_health_check" "http" {
  ...
  project = var.project_id
  name    = "${var.hostname}-http_healthcheck"
